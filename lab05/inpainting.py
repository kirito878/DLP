...
#mask_b: iteration decoding initial mask, where mask_b is true means mask
    def inpainting(self,image,mask_b,i): #MakGIT inference
        ...
        with torch.no_grad():
            ...
            _, z_indices = self.model.encode_to_z(image.to(device=self.device)) 
            ...
            for step in range(self.total_iter):
                ...
                shape=(1,16,16,256)
                # self.model.vqgan.codebook.embedding(z_indices_predict) shape : (1,256,256)
...
#TODO3 step1-2: modify the path, MVTM parameters
    parser.add_argument('--load-transformer-ckpt-path', type=str, default='/home/wujh1123/lab5/transformer_checkpoints/epoch_10_ckpt.pth', help='load ckpt')
    ...
    with tqdm(total=len(t.mi_ori)) as pbar:
        i=0
